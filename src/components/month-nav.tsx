...
export function MonthNav() {
  ...
  return (
    <View className="mb-sm flex-row items-center justify-center gap-md">
      <Pressable onPress={goToPreviousMonth} hitSlop={12}>
        <Text className="text-title-lg text-muted">‹</Text>
      </Pressable>
      <Text className="font-display text-title-lg font-bold text-ink">{label}</Text>
